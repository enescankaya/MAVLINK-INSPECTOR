...
public partial class MAVLink
{
    ...
    public class MavlinkParse
    {
        ...
        public static bool ReadWithTimeout(Stream BaseStream, byte[] buffer, int offset, int count)
        {
            int timeout = 500;
        ...
        public MAVLinkMessage ReadPacket(Stream BaseStream)
        {
            ...
            {
                // read STX byte
                if (ReadWithTimeout(BaseStream, buffer, 0, 1) == false)
                {
                    return null;
                }
            ...
            // read header
            if (ReadWithTimeout(BaseStream, buffer, 1, headerlength) == false)
            {
                return null;
            }
            ...
            //read rest of packet
            if (ReadWithTimeout(BaseStream, buffer, headerlengthstx, lengthtoread - (headerlengthstx - 2)) == false)
            {
                return null;
            }
